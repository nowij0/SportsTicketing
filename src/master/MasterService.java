...
public class MasterService {
	...
	//회원정보 삭제delete - id로
		...
		public void insertSports(Scanner sc) {
			...
			dao.insertSports(new SportsVo(1, name, date, location, team, txt));		
		...
		public void editSports(Scanner sc) {
			...
			for(Integer i : list) {
				if (i!=num) {
					System.out.println("없는경기번호. 다시입력하시오");
				} else {
					...
					dao.update(new SportsVo(0, name, date, location, team, text));
